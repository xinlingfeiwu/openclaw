...
k.makeIterator = function (a) {
  const c = "undefined" != typeof Symbol && Symbol.iterator && a[Symbol.iterator];
...
k.arrayFromIterable = function (a) {
  return Array.isArray(a) ? a : k.arrayFromIterator(k.makeIterator(a));
};
k.ASSUME_ES5 = !1;
...
k.objectCreate =
  k.ASSUME_ES5 || typeof Object.create == "function"
    ? Object.create
    : function (a) {
        const c = function () {};
        c.prototype = a;
...
k.defineProperty =
  k.ASSUME_ES5 || typeof Object.defineProperties == "function"
...
k.IS_SYMBOL_NATIVE = typeof Symbol === "function" && typeof Symbol("x") === "symbol";
...
k.polyfill = function (a, c, d) {
  c && (k.ISOLATE_POLYFILLS ? k.polyfillIsolated(a, c, d) : k.polyfillUnisolated(a, c));
};
k.polyfillUnisolated = function (a, c) {
  ...
  e = d[a];
  c = c(e);
  c != e && c != null && k.defineProperty(d, a, { configurable: !0, writable: !0, value: c });
};
k.polyfillIsolated = function (a, c, d) {
  ...
  e = e[e.length - 1];
  d = k.IS_SYMBOL_NATIVE && d === "es6" ? f[e] : null;
  c = c(d);
  c != null &&
    (a
      ? k.defineProperty(k.polyfills, e, { configurable: !0, writable: !0, value: c })
      : c !== d &&
...
k.getConstructImplementation = function () {
  ...
  if (k.TRUST_ES6_POLYFILLS && typeof Reflect != "undefined" && Reflect.construct) {
    if (a()) {
...
k.setPrototypeOf =
  k.TRUST_ES6_POLYFILLS && typeof Object.setPrototypeOf == "function"
...
k.checkStringArgs = function (a, c, d) {
  if (a == null) {
    throw new TypeError(
      "The 'this' value for String.prototype." + d + " must not be null or undefined",
    );
  }
  if (c instanceof RegExp) {
    throw new TypeError(
      "First argument to String.prototype." + d + " must not be a regular expression",
    );
  }
  return a + "";
};
k.polyfill(
  ...
  function (a) {
    return a
      ? a
      : function (c, d) {
          const e = k.checkStringArgs(this, c, "endsWith");
          c += "";
          void 0 === d && (d = e.length);
          d = Math.max(0, Math.min(d | 0, e.length));
          for (var f = c.length; f > 0 && d > 0; ) {
            if (e[--d] != c[--f]) {
              return !1;
            }
          }
...
k.polyfill(
  ...
  function (a) {
    return a
      ? a
      : function (c, d) {
          const e = k.checkStringArgs(this, c, "startsWith");
          c += "";
          const f = e.length,
            g = c.length;
          d = Math.max(0, Math.min(d | 0, e.length));
...
k.polyfill(
  ...
  function (a) {
    return a
      ? a
      : function (c) {
          let d = k.checkStringArgs(this, null, "repeat");
          if (c < 0 || c > 1342177279) {
...
k.polyfill(
  ...
  function (a) {
    ...
    const c = function (f, g) {
      ...
      k.defineProperty(this, "description", { configurable: !0, writable: !0, value: g });
    };
...
k.polyfill(
  ...
  function (a) {
    ...
    for (
      ...
      const e = k.global[c[d]];
      typeof e === "function" &&
        typeof e.prototype[a] != "function" &&
...
m.exportPath_ = function (a, c, d, e) {
  a = a.split(".");
  e = e || m.global;
  a[0] in e || typeof e.execScript == "undefined" || e.execScript("var " + a[0]);
  for (let f; a.length && (f = a.shift()); ) {
    if (a.length || void 0 === c) {
      e = e[f] && e[f] !== Object.prototype[f] ? e[f] : (e[f] = {});
    } else if (!d && m.isObject(c) && m.isObject(e[f])) {
      for (let g in c) {
        c.hasOwnProperty(g) && (e[f][g] = c[g]);
      }
    } else {
      e[f] = c;
    }
...
m.getScriptNonce = function (a) {
  if (a && a != m.global) {
    return m.getScriptNonce_(a.document);
  }
  m.cspNonce_ === null && (m.cspNonce_ = m.getScriptNonce_(m.global.document));
  return m.cspNonce_;
};
...
m.module = function (a) {
  if (typeof a !== "string" || !a || a.search(m.VALID_MODULE_RE_) == -1) {
...
m.declareModuleId = function (a) {
  if (m.moduleLoaderState_) {
    m.moduleLoaderState_.moduleName = a;
  } else {
    let c = m.global.$jscomp;
...
m.loadModule = function (a) {
  const c = m.moduleLoaderState_;
  try {
    m.moduleLoaderState_ = { moduleName: "", declareLegacyNamespace: !1, type: m.ModuleType.GOOG };
    let d = {},
      e = d;
    ...
    const f = m.moduleLoaderState_.moduleName;
    if (typeof f === "string" && f) {
      ...
      throw new Error('Invalid module name "' + f + '"');
    }
  } finally {
...
m.loadFileSync_ = function (a) {
  ...
  try {
    const c = new m.global.XMLHttpRequest();
    c.open("get", a, !1);
    c.send();
...
m.transpile_ = function (a, c, d) {
  let e = m.global.$jscomp;
  e || (m.global.$jscomp = e = {});
  let f = e.transpile;
  if (!f) {
    const g = m.basePath + m.TRANSPILER,
      h = m.loadFileSync_(g);
    if (h) {
      (function () {
        (0, eval)(h + "\n//# sourceURL=" + g);
  ...
  if (!f) {
    let l = " requires transpilation but no transpiler was found.";
    l +=
...
m.isDateLike = function (a) {
  return m.isObject(a) && typeof a.getFullYear == "function";
};
...
m.getUid = function (a) {
  return (
    (Object.prototype.hasOwnProperty.call(a, m.UID_PROPERTY_) && a[m.UID_PROPERTY_]) ||
...
m.removeUid = function (a) {
  a !== null && "removeAttribute" in a && a.removeAttribute(m.UID_PROPERTY_);
  try {
...
m.getCssName = function (a, c) {
  ...
  e = m.cssNameMapping_
    ? m.cssNameMappingStyle_ == "BY_WHOLE"
      ? d
      : e
    : function (f) {
        return f;
...
m.defineClass = function (a, c) {
  ...
  e != null && (e instanceof Function ? e(d) : m.defineClass.applyProperties_(d, e));
  return d;
};
...
m.defineClass.createSealingConstructor_ = function (a) {
  return m.defineClass.SEAL_CLASS_INSTANCES
    ? function () {
        const c = a.apply(this, arguments) || this;
...
m.defineClass.applyProperties_ = function (a, c) {
  ...
  for (let e = 0; e < m.defineClass.OBJECT_PROTOTYPE_FIELDS_.length; e++) {
...
m.createTrustedTypesPolicy = function () {
  let a = m.TRUSTED_TYPES_POLICY_NAME + "#html",
    c = null,
...
m.asserts.assert = function (a, c, d) {
  m.asserts.ENABLE_ASSERTS &&
    !a &&
    m.asserts.doAssertFailure_("", null, c, Array.prototype.slice.call(arguments, 2));
  return a;
};
...
const u = 2012 < m.FEATURESET_YEAR;
...
const ca =
  m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.lastIndexOf)
    ...
    : function (a, c, d) {
        ...
        if ("string" === typeof a) {
          return "string" !== typeof c || 1 != c.length ? -1 : a.lastIndexOf(c, d);
        }
        for (; 0 <= d; d--) {
          if (d in a && a[d] === c) {
            return d;
...
const w =
  m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.forEach)
    ...
    : function (a, c, d) {
        for (var e = a.length, f = "string" === typeof a ? a.split("") : a, g = 0; g < e; g++) {
...
const ea =
  m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.filter)
    ...
    : function (a, c, d) {
        for (
          var e = a.length, f = [], g = 0, h = "string" === typeof a ? a.split("") : a, l = 0;
          l < e;
          l++
        ) {
          if (l in h) {
...
const x =
  m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.map)
    ...
    : function (a, c, d) {
        for (
          var e = a.length, f = Array(e), g = "string" === typeof a ? a.split("") : a, h = 0;
          h < e;
          h++
        ) {
...
m.array.reduceRight =
  m.NATIVE_ARRAY_PROTOTYPES && (u || Array.prototype.reduceRight)
    ? function (a, c, d, e) {
        m.asserts.assert(a.length != null);
        m.asserts.assert(c != null);
        e && (c = m.bind(c, e));
...
m.array.find = ja;
function ka(a, c, d) {
  for (let e = a.length, f = "string" === typeof a ? a.split("") : a, g = 0; g < e; g++) {
    if (g in f && c.call(d, f[g], g, a)) {
      return g;
    }
  }
...
m.array.insertBefore = function (a, c, d) {
  let e;
  arguments.length == 2 || (e = ba(a, d)) < 0 ? a.push(c) : na(a, c, e);
};
function pa(a, c) {
  c = ba(a, c);
  let d;
...
m.array.removeLast = function (a, c) {
  c = ca(a, c);
  return c >= 0 ? (A(a, c), !0) : !1;
};
function A(a, c) {
  m.asserts.assert(a.length != null);
  return Array.prototype.splice.call(a, c, 1).length == 1;
}
m.array.removeAt = A;
...
function sa(a, c, d, e, f) {
  for (var g = 0, h = a.length, l; g < h; ) {
    const n = g + ((h - g) >>> 1);
    const p = d ? c.call(f, a[n], n, a) : c(e, a[n]);
    p > 0 ? (g = n + 1) : ((h = n), (l = !p));
  }
  return l ? g : -g - 1;
}
...
m.array.equals = function (a, c) {
  ...
  for (let d = a.length, e = wa, f = 0; f < d; f++) {
    if (!e(a[f], c[f])) {
      return !1;
    }
  }
...
m.array.compare3 = function (a, c, d) {
  d = d || E;
  for (let e = Math.min(a.length, c.length), f = 0; f < e; f++) {
    const g = d(a[f], c[f]);
    if (g != 0) {
      return g;
    }
...
m.array.rotate = function (a, c) {
  ...
  a.length &&
    ...
    c > 0
      ...
      : c < 0 && Array.prototype.push.apply(a, a.splice(0, -c)));
  return a;
};
m.array.moveItem = function (a, c, d) {
  m.asserts.assert(c >= 0 && c < a.length);
  m.asserts.assert(d >= 0 && d < a.length);
...
m.debug.errorcontext.addErrorContext = function (a, c, d) {
  a[m.debug.errorcontext.CONTEXT_KEY_] || (a[m.debug.errorcontext.CONTEXT_KEY_] = {});
...
m.string.internal.endsWith = function (a, c) {
  ...
  return d >= 0 && a.indexOf(c, d) == d;
};
m.string.internal.caseInsensitiveStartsWith = function (a, c) {
  return m.string.internal.caseInsensitiveCompare(c, a.substr(0, c.length)) == 0;
};
m.string.internal.caseInsensitiveEndsWith = function (a, c) {
  return m.string.internal.caseInsensitiveCompare(c, a.substr(a.length - c.length, c.length)) == 0;
};
...
m.string.internal.htmlEscape = function (a, c) {
  if (c) {
    ...
    if (!m.string.internal.ALL_RE_.test(a)) {
      return a;
    }
    a.indexOf("&") != -1 && (a = a.replace(m.string.internal.AMP_RE_, "&amp;"));
    a.indexOf("<") != -1 && (a = a.replace(m.string.internal.LT_RE_, "&lt;"));
    a.indexOf(">") != -1 && (a = a.replace(m.string.internal.GT_RE_, "&gt;"));
    a.indexOf('"') != -1 && (a = a.replace(m.string.internal.QUOT_RE_, "&quot;"));
    a.indexOf("'") != -1 && (a = a.replace(m.string.internal.SINGLE_QUOTE_RE_, "&#39;"));
    a.indexOf("\x00") != -1 && (a = a.replace(m.string.internal.NULL_RE_, "&#0;"));
  }
  return a;
};
...
m.string.internal.whitespaceEscape = function (a) {
  return m.string.internal.newLineToBr(a.replace(/ {2}/g, " &#160;"), void 0);
};
...
m.string.internal.compareVersions = function (a, c) {
  ...
  for (let e = Math.max(a.length, c.length), f = 0; d == 0 && f < e; f++) {
    let g = a[f] || "",
      h = c[f] || "";
    do {
      g = /(\d*)(\D*)(.*)/.exec(g) || ["", "", "", ""];
      ...
      d =
        m.string.internal.compareElements_(
          g[1].length == 0 ? 0 : Number.parseInt(g[1], 10),
          h[1].length == 0 ? 0 : Number.parseInt(h[1], 10),
        ) ||
        m.string.internal.compareElements_(g[2].length == 0, h[2].length == 0) ||
...
m.labs.userAgent.util.getNativeUserAgentString_ = function () {
  let a = m.labs.userAgent.util.getNavigator_();
  return a && (a = a.userAgent) ? a : "";
};
m.labs.userAgent.util.getNavigator_ = function () {
  return m.global.navigator;
};
m.labs.userAgent.util.userAgent_ = m.labs.userAgent.util.getNativeUserAgentString_();
m.labs.userAgent.util.setUserAgent = function (a) {
  m.labs.userAgent.util.userAgent_ = a || m.labs.userAgent.util.getNativeUserAgentString_();
};
...
m.labs.userAgent.util.matchUserAgentIgnoreCase = function (a) {
  return m.string.internal.caseInsensitiveContains(m.labs.userAgent.util.getUserAgent(), a);
};
...
m.object.add = function (a, c, d) {
  if (a !== null && c in a) {
    throw new Error('The object already contains the key "' + c + '"');
  }
  m.object.set(a, c, d);
};
m.object.get = function (a, c, d) {
  return a !== null && c in a ? a[c] : d;
};
...
m.object.extend = function (a, c) {
  for (let d, e, f = 1; f < arguments.length; f++) {
    e = arguments[f];
    for (d in e) {
      a[d] = e[d];
    }
    for (let g = 0; g < m.object.PROTOTYPE_FIELDS_.length; g++) {
...
m.object.create = function (a) {
  ...
  if (c == 1 && Array.isArray(arguments[0])) {
...
m.object.getAllPropertyNames = function (a, c, d) {
  ...
  for (var e = {}; a && (a !== Object.prototype || c) && (a !== Function.prototype || d); ) {
    for (let f = Object.getOwnPropertyNames(a), g = 0; g < f.length; g++) {
      e[f[g]] = !0;
    }
...
m.labs.userAgent.browser.matchIE_ = function () {
  return (
    m.labs.userAgent.util.matchUserAgent("Trident") || m.labs.userAgent.util.matchUserAgent("MSIE")
  );
};
...
m.labs.userAgent.browser.matchFirefox_ = function () {
  return (
    m.labs.userAgent.util.matchUserAgent("Firefox") || m.labs.userAgent.util.matchUserAgent("FxiOS")
  );
};
...
m.labs.userAgent.browser.isEdgeChromium = m.labs.userAgent.browser.matchEdgeChromium_;
m.labs.userAgent.browser.isOperaChromium = m.labs.userAgent.browser.matchOperaChromium_;
...
m.labs.userAgent.browser.isIosWebview = m.labs.userAgent.browser.matchIosWebview_;
m.labs.userAgent.browser.isChrome = m.labs.userAgent.browser.matchChrome_;
m.labs.userAgent.browser.isAndroidBrowser = m.labs.userAgent.browser.matchAndroidBrowser_;
...
m.labs.userAgent.browser.getVersion = function () {
  ...
  let c = m.labs.userAgent.util.getUserAgent();
  ...
  const e = m.partial(m.object.containsKey, d);
...
m.labs.userAgent.browser.isVersionOrHigher = function (a) {
  return m.string.internal.compareVersions(m.labs.userAgent.browser.getVersion(), a) >= 0;
};
m.labs.userAgent.browser.getIEVersion_ = function (a) {
  ...
  c = "";
  const d = /MSIE +([\d.]+)/.exec(a);
  if (d && d[1]) {
    if (((a = /Trident\/(\d.\d)/.exec(a)), d[1] == "7.0")) {
      if (a && a[1]) {
        switch (a[1]) {
          case "4.0":
            c = "8.0";
...
m.dom.asserts.assertIsLocation = function (a) {
  if (m.asserts.ENABLE_ASSERTS) {
    const c = m.dom.asserts.getWindow_(a);
    c &&
...
m.dom.asserts.assertIsElementType_ = function (a, c) {
  if (m.asserts.ENABLE_ASSERTS) {
    const d = m.dom.asserts.getWindow_(a);
    d &&
      typeof d[c] != "undefined" &&
      ((a && (a instanceof d[c] || !(a instanceof d.Location || a instanceof d.Element))) ||
        m.asserts.fail(
...
m.html.trustedtypes.getPolicyPrivateDoNotAccessOrElse = function () {
  if (!m.TRUSTED_TYPES_POLICY_NAME) {
    return null;
  }
...
m.string.Const = function (a, c) {
  ...
  this.STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_ = m.string.Const.TYPE_MARKER_;
};
...
m.string.Const.unwrap = function (a) {
  if (
    ...
    a.STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_ === m.string.Const.TYPE_MARKER_
  ) {
...
m.string.Const.from = function (a) {
  return new m.string.Const(m.string.Const.GOOG_STRING_CONSTRUCTOR_TOKEN_PRIVATE_, a);
};
...
G.fromConstant = function (a) {
  ...
  return a.length === 0 ? G.EMPTY : Ba(a);
};
...
const Ca = function (a) {
    ...
    (0, m.asserts.fail)(
      "expected object of type SafeScript, got '" + a + "' of type " + m.typeOf(a),
    );
...
m.fs.url.getUrlObject_ = function () {
  const a = m.fs.url.findUrlObject_();
  if (a != null) {
    return a;
  }
...
m.fs.url.browserSupportsObjectUrls = function () {
  return m.fs.url.findUrlObject_() != null;
};
m.fs.blob = {};
m.fs.blob.getBlob = function (a) {
  let c = m.global.BlobBuilder || m.global.WebKitBlobBuilder;
  if (void 0 !== c) {
    c = new c();
    for (let d = 0; d < arguments.length; d++) {
      c.append(arguments[d]);
    }
    return c.getBlob();
  }
...
m.fs.blob.getBlobWithProperties = function (a, c) {
  let d = m.global.BlobBuilder || m.global.WebKitBlobBuilder;
  if (void 0 !== d) {
    d = new d();
...
m.i18n.bidi.IS_RTL =
  ...
  ((m.LOCALE.substring(0, 2).toLowerCase() == "ar" ||
    m.LOCALE.substring(0, 2).toLowerCase() == "fa" ||
    m.LOCALE.substring(0, 2).toLowerCase() == "he" ||
    m.LOCALE.substring(0, 2).toLowerCase() == "iw" ||
    m.LOCALE.substring(0, 2).toLowerCase() == "ps" ||
    m.LOCALE.substring(0, 2).toLowerCase() == "sd" ||
    m.LOCALE.substring(0, 2).toLowerCase() == "ug" ||
    m.LOCALE.substring(0, 2).toLowerCase() == "ur" ||
    m.LOCALE.substring(0, 2).toLowerCase() == "yi") &&
    (m.LOCALE.length == 2 || m.LOCALE.substring(2, 3) == "-" || m.LOCALE.substring(2, 3) == "_")) ||
  (m.LOCALE.length >= 3 &&
    m.LOCALE.substring(0, 3).toLowerCase() == "ckb" &&
    (m.LOCALE.length == 3 || m.LOCALE.substring(3, 4) == "-" || m.LOCALE.substring(3, 4) == "_")) ||
  (m.LOCALE.length >= 7 &&
    (m.LOCALE.substring(2, 3) == "-" || m.LOCALE.substring(2, 3) == "_") &&
    (m.LOCALE.substring(3, 7).toLowerCase() == "adlm" ||
      m.LOCALE.substring(3, 7).toLowerCase() == "arab" ||
      m.LOCALE.substring(3, 7).toLowerCase() == "hebr" ||
      m.LOCALE.substring(3, 7).toLowerCase() == "nkoo" ||
      m.LOCALE.substring(3, 7).toLowerCase() == "rohg" ||
      m.LOCALE.substring(3, 7).toLowerCase() == "thaa")) ||
  (m.LOCALE.length >= 8 &&
    (m.LOCALE.substring(3, 4) == "-" || m.LOCALE.substring(3, 4) == "_") &&
    (m.LOCALE.substring(4, 8).toLowerCase() == "adlm" ||
      m.LOCALE.substring(4, 8).toLowerCase() == "arab" ||
      m.LOCALE.substring(4, 8).toLowerCase() == "hebr" ||
      m.LOCALE.substring(4, 8).toLowerCase() == "nkoo" ||
      m.LOCALE.substring(4, 8).toLowerCase() == "rohg" ||
      m.LOCALE.substring(4, 8).toLowerCase() == "thaa"));
m.i18n.bidi.Format = { LRE: "\u202a", RLE: "\u202b", PDF: "\u202c", LRM: "\u200e", RLM: "\u200f" };
m.i18n.bidi.Dir = { LTR: 1, RTL: -1, NEUTRAL: 0 };
m.i18n.bidi.RIGHT = "right";
m.i18n.bidi.LEFT = "left";
m.i18n.bidi.I18N_RIGHT = m.i18n.bidi.IS_RTL ? m.i18n.bidi.LEFT : m.i18n.bidi.RIGHT;
m.i18n.bidi.I18N_LEFT = m.i18n.bidi.IS_RTL ? m.i18n.bidi.RIGHT : m.i18n.bidi.LEFT;
...
m.i18n.bidi.hasAnyLtr = function (a) {
  return m.i18n.bidi.ltrCharReg_.test(m.i18n.bidi.stripHtmlIfNeeded_(a, void 0));
};
...
m.i18n.bidi.isNeutralText = function (a, c) {
  ...
  return (
    m.i18n.bidi.isRequiredLtrRe_.test(a) || (!m.i18n.bidi.hasAnyLtr(a) && !m.i18n.bidi.hasAnyRtl(a))
  );
};
...
m.i18n.bidi.endsWithLtr = function (a, c) {
  return m.i18n.bidi.ltrExitDirCheckRe_.test(m.i18n.bidi.stripHtmlIfNeeded_(a, c));
};
m.i18n.bidi.isLtrExitText = m.i18n.bidi.endsWithLtr;
m.i18n.bidi.endsWithRtl = function (a, c) {
  return m.i18n.bidi.rtlExitDirCheckRe_.test(m.i18n.bidi.stripHtmlIfNeeded_(a, c));
};
...
m.i18n.bidi.dimensionsRe_ = /:\s*([.\d][.\w]*)\s+([.\d][.\w]*)\s+([.\d][.\w]*)\s+([.\d][.\w]*)/g;
...
m.i18n.bidi.setElementDirAndAlign = function (a, c) {
  a &&
    ...
    ((a.style.textAlign = c == m.i18n.bidi.Dir.RTL ? m.i18n.bidi.RIGHT : m.i18n.bidi.LEFT),
...
m.html.TrustedResourceUrl.unwrapTrustedScriptURL = function (a) {
  if (a instanceof m.html.TrustedResourceUrl && a.constructor === m.html.TrustedResourceUrl) {
    return a.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue_;
  }
  m.asserts.fail(
    "expected object of type TrustedResourceUrl, got '" + a + "' of type " + m.typeOf(a),
  );
  return "type_error:TrustedResourceUrl";
};
m.html.TrustedResourceUrl.format = function (a, c) {
  const d = m.string.Const.unwrap(a);
  if (!m.html.TrustedResourceUrl.BASE_URL_.test(d)) {
    throw new Error("Invalid TrustedResourceUrl format: " + d);
  }
  a = d.replace(m.html.TrustedResourceUrl.FORMAT_MARKER_, function (e, f) {
    ...
    e = c[f];
    return e instanceof m.string.Const ? m.string.Const.unwrap(e) : encodeURIComponent(String(e));
  });
  return m.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(a);
};
...
m.html.TrustedResourceUrl.fromConstants = function (a) {
  for (var c = "", d = 0; d < a.length; d++) {
    c += m.string.Const.unwrap(a[d]);
  }
  return m.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(c);
};
...
m.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse = function (a) {
  const c = m.html.trustedtypes.getPolicyPrivateDoNotAccessOrElse();
  a = c ? c.createScriptURL(a) : a;
  return new m.html.TrustedResourceUrl(a, m.html.TrustedResourceUrl.CONSTRUCTOR_TOKEN_PRIVATE_);
};
m.html.TrustedResourceUrl.stringifyParams_ = function (a, c, d) {
  ...
  if (typeof d === "string") {
    return d ? a + encodeURIComponent(d) : "";
  }
  for (let e in d) {
...
m.html.SafeUrl.unwrap = function (a) {
  ...
  m.asserts.fail("expected object of type SafeUrl, got '" + a + "' of type " + m.typeOf(a));
  return "type_error:SafeUrl";
};
m.html.SafeUrl.fromConstant = function (a) {
  return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(m.string.Const.unwrap(a));
};
...
m.html.SafeUrl.fromMediaSource = function (a) {
  ...
  a = a instanceof MediaSource ? m.fs.url.createObjectUrl(a) : m.html.SafeUrl.INNOCUOUS_STRING;
  return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a);
};
...
m.html.SafeUrl.tryFromDataUrl = function (a) {
  a = String(a);
  a = a.replace(/(%0A|%0D)/g, "");
  const c = a.match(m.html.DATA_URL_PATTERN_);
...
m.html.SafeUrl.fromTelUrl = function (a) {
  m.string.internal.caseInsensitiveStartsWith(a, "tel:") || (a = m.html.SafeUrl.INNOCUOUS_STRING);
  return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a);
};
m.html.SIP_URL_PATTERN_ = /^sip[s]?:[+a-z0-9_.!$%&'*/=^`{|}~-]+@([a-z0-9-]+\.)+[a-z0-9]{2,63}$/i;
m.html.SafeUrl.fromSipUrl = function (a) {
  m.html.SIP_URL_PATTERN_.test(decodeURIComponent(a)) || (a = m.html.SafeUrl.INNOCUOUS_STRING);
  return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a);
};
...
m.html.SafeUrl.fromSshUrl = function (a) {
  m.string.internal.caseInsensitiveStartsWith(a, "ssh://") || (a = m.html.SafeUrl.INNOCUOUS_STRING);
  return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a);
};
m.html.SafeUrl.sanitizeChromeExtensionUrl = function (a, c) {
  return m.html.SafeUrl.sanitizeExtensionUrl_(/^chrome-extension:\/\/([^/]+)\//, a, c);
};
m.html.SafeUrl.sanitizeFirefoxExtensionUrl = function (a, c) {
  return m.html.SafeUrl.sanitizeExtensionUrl_(/^moz-extension:\/\/([^/]+)\//, a, c);
};
m.html.SafeUrl.sanitizeEdgeExtensionUrl = function (a, c) {
  return m.html.SafeUrl.sanitizeExtensionUrl_(/^ms-browser-extension:\/\/([^/]+)\//, a, c);
};
m.html.SafeUrl.sanitizeExtensionUrl_ = function (a, c, d) {
  (a = a.exec(c))
    ? ((a = a[1]),
      ...
      ).indexOf(a) == -1 && (c = m.html.SafeUrl.INNOCUOUS_STRING))
...
m.html.SafeUrl.sanitizeAssertUnchanged = function (a, c) {
  ...
  m.asserts.assert(m.html.SAFE_URL_PATTERN_.test(a), "%s does not match the safe URL pattern", a) ||
    (a = m.html.SafeUrl.INNOCUOUS_STRING);
  return m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a);
};
...
m.html.SafeUrl.INNOCUOUS_URL = m.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(
  m.html.SafeUrl.INNOCUOUS_STRING,
);
...
m.html.SafeStyle.unwrap = function (a) {
  ...
  m.asserts.fail("expected object of type SafeStyle, got '" + a + "' of type " + m.typeOf(a));
  return "type_error:SafeStyle";
};
m.html.SafeStyle.CONSTRUCTOR_TOKEN_PRIVATE_ = {};
m.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse = function (a) {
  return new m.html.SafeStyle(a, m.html.SafeStyle.CONSTRUCTOR_TOKEN_PRIVATE_);
};
m.html.SafeStyle.EMPTY = m.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse("");
  ...
  for (d in a) {
    if (Object.prototype.hasOwnProperty.call(a, d)) {
      if (!/^[-_a-zA-Z0-9]+$/.test(d)) {
        throw new Error("Name allows only [-_a-zA-Z0-9], got: " + d);
      }
      let e = a[d];
      e != null &&
        ((e = Array.isArray(e)
...
m.html.SafeStyle.sanitizePropertyValue_ = function (a) {
  if (a instanceof m.html.SafeUrl) {
    return 'url("' + m.html.SafeUrl.unwrap(a).replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") + '")';
  }
  a =
    a instanceof m.string.Const
      ? m.string.Const.unwrap(a)
  ...
  if (/[{;}]/.test(a)) {
    throw new m.asserts.AssertionError("Value does not allow [{;}], got: %s.", [a]);
  }
  return a;
};
...
m.html.SafeStyle.VALUE_RE_ = new RegExp("^" + m.html.SafeStyle.VALUE_ALLOWED_CHARS_ + "+$");
...
m.html.SafeStyle.FUNCTIONS_RE_ = new RegExp(
  "\\b(" + m.html.SafeStyle.ALLOWED_FUNCTIONS_.join("|") + ")\\([-+*/0-9a-z.%\\[\\], ]+\\)",
  "g",
);
...
I.unwrap = function (a) {
  ...
  (0, m.asserts.fail)(
    "expected object of type SafeStyleSheet, got '" + a + "' of type " + m.typeOf(a),
  );
...
m.html.SafeHtml.unwrapTrustedHTML = function (a) {
  ...
  m.asserts.fail("expected object of type SafeHtml, got '" + a + "' of type " + m.typeOf(a));
  return "type_error:SafeHtml";
};
m.html.SafeHtml.htmlEscape = function (a) {
  if (a instanceof m.html.SafeHtml) {
    return a;
  }
  ...
  return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
    m.string.internal.htmlEscape(
      c && a.implementsGoogStringTypedString ? a.getTypedStringValue() : String(a),
    ),
    d,
  );
};
...
m.html.SafeHtml.create = function (a, c, d) {
  ...
  return m.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse(String(a), c, d);
};
m.html.SafeHtml.verifyTagName = function (a) {
  if (!m.html.SafeHtml.VALID_NAMES_IN_TAG_.test(a)) {
    throw new Error(m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? "Invalid tag name <" + a + ">." : "");
  }
...
m.html.SafeHtml.createIframe = function (a, c, d, e) {
  ...
  return m.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("iframe", a, e);
};
...
m.html.SafeHtml.canUseSandboxIframe = function () {
  return m.global.HTMLIFrameElement && "sandbox" in m.global.HTMLIFrameElement.prototype;
};
m.html.SafeHtml.createScriptSrc = function (a, c) {
  m.html.TrustedResourceUrl.unwrap(a);
  a = m.html.SafeHtml.combineAttributes({ src: a }, {}, c);
  return m.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("script", a);
};
m.html.SafeHtml.createScript = function (a, c) {
  for (var d in c) {
    if (Object.prototype.hasOwnProperty.call(c, d)) {
      var e = d.toLowerCase();
      if (e == "language" || e == "src" || e == "text" || e == "type") {
        throw new Error(
          m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Cannot set "' + e + '" attribute' : "",
        );
      }
    }
  }
  ...
  a = m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(d, m.i18n.bidi.Dir.NEUTRAL);
  return m.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("script", c, a);
};
m.html.SafeHtml.createStyle = function (a, c) {
  ...
  a = m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(d, m.i18n.bidi.Dir.NEUTRAL);
  return m.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("style", c, a);
};
m.html.SafeHtml.createMetaRefresh = function (a, c) {
  ...
  (m.labs.userAgent.browser.isIE() || m.labs.userAgent.browser.isEdge()) &&
    m.string.internal.contains(a, ";") &&
    (a = "'" + a.replace(/'/g, "%27") + "'");
  return m.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse("meta", {
    "http-equiv": "refresh",
    content: (c || 0) + "; url=" + a,
  });
};
m.html.SafeHtml.getAttrNameAndValue_ = function (a, c, d) {
  if (d instanceof m.string.Const) {
    d = m.string.Const.unwrap(d);
  } else if (c.toLowerCase() == "style") {
    if (m.html.SafeHtml.SUPPORT_STYLE_ATTRIBUTE) {
      d = m.html.SafeHtml.getStyleValue_(d);
    } else {
      throw new Error(
        m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Attribute "style" not supported.' : "",
      );
    }
  } else {
    if (/^on/i.test(c)) {
      throw new Error(
        m.html.SafeHtml.ENABLE_ERROR_MESSAGES
          ? 'Attribute "' + c + '" requires goog.string.Const value, "' + d + '" given.'
          : "",
      );
    }
    if (c.toLowerCase() in m.html.SafeHtml.URL_ATTRIBUTES_) {
      ...
      } else if (d instanceof m.html.SafeUrl) {
        d = m.html.SafeUrl.unwrap(d);
...
m.html.SafeHtml.concat = function (a) {
  return m.html.SafeHtml.join(m.html.SafeHtml.EMPTY, Array.prototype.slice.call(arguments));
};
m.html.SafeHtml.concatWithDir = function (a, c) {
  const d = m.html.SafeHtml.concat(D(arguments, 1));
  d.dir_ = a;
  return d;
};
m.html.SafeHtml.CONSTRUCTOR_TOKEN_PRIVATE_ = {};
m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse = function (a, c) {
  const d = m.html.trustedtypes.getPolicyPrivateDoNotAccessOrElse();
  a = d ? d.createHTML(a) : a;
  return new m.html.SafeHtml(a, c, m.html.SafeHtml.CONSTRUCTOR_TOKEN_PRIVATE_);
};
m.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse = function (a, c, d) {
  let e = null;
  let f = "<" + a + m.html.SafeHtml.stringifyAttributes(a, c);
  d == null ? (d = []) : Array.isArray(d) || (d = [d]);
  m.dom.tags.isVoidTag(a.toLowerCase())
    ? (m.asserts.assert(!d.length, "Void tag <" + a + "> does not allow content."), (f += ">"))
    : ((e = m.html.SafeHtml.concat(d)),
      (f += ">" + m.html.SafeHtml.unwrap(e) + "</" + a + ">"),
      (e = e.getDirection()));
  (a = c && c.dir) && (e = /^(ltr|rtl|auto)$/i.test(a) ? m.i18n.bidi.Dir.NEUTRAL : null);
    ...
    for (let e in c) {
      if (Object.prototype.hasOwnProperty.call(c, e)) {
        if (!m.html.SafeHtml.VALID_NAMES_IN_TAG_.test(e)) {
          throw Error(
            m.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Invalid attribute name "' + e + '".' : "",
          );
        }
        const f = c[e];
        f != null && (d += " " + m.html.SafeHtml.getAttrNameAndValue_(a, e, f));
      }
    }
  }
  return d;
...
m.html.SafeHtml.combineAttributes = function (a, c, d) {
  ...
  for (f in a) {
    Object.prototype.hasOwnProperty.call(a, f) &&
      (m.asserts.assert(f.toLowerCase() == f, "Must be lower case"), (e[f] = a[f]));
  }
  for (f in c) {
    Object.prototype.hasOwnProperty.call(c, f) &&
      (m.asserts.assert(f.toLowerCase() == f, "Must be lower case"), (e[f] = c[f]));
  }
  if (d) {
    for (f in d) {
      if (Object.prototype.hasOwnProperty.call(d, f)) {
        ...
        if (g in a) {
          throw Error(
            m.html.SafeHtml.ENABLE_ERROR_MESSAGES
              ? 'Cannot override "' + g + '" attribute, got "' + f + '" with value "' + d[f] + '"'
              : "",
          );
        }
        g in c && delete e[g];
...
m.html.SafeHtml.DOCTYPE_HTML = m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
  "<!DOCTYPE html>",
  m.i18n.bidi.Dir.NEUTRAL,
);
...
m.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract = function (a, c) {
  m.asserts.assertString(m.string.Const.unwrap(a), "must provide justification");
  m.asserts.assert(
    !m.string.internal.isEmptyOrWhitespace(m.string.Const.unwrap(a)),
    "must provide non-empty justification",
  );
  return m.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(c, null);
};
m.html.uncheckedconversions.safeScriptFromStringKnownToSatisfyTypeContract = function (a, c) {
  m.asserts.assertString(m.string.Const.unwrap(a), "must provide justification");
  m.asserts.assert(
    !m.string.internal.isEmptyOrWhitespace(m.string.Const.unwrap(a)),
    "must provide non-empty justification",
...
m.html.uncheckedconversions.safeStyleFromStringKnownToSatisfyTypeContract = function (a, c) {
  m.asserts.assertString(m.string.Const.unwrap(a), "must provide justification");
  m.asserts.assert(
    !m.string.internal.isEmptyOrWhitespace(m.string.Const.unwrap(a)),
    "must provide non-empty justification",
...
m.html.uncheckedconversions.safeStyleSheetFromStringKnownToSatisfyTypeContract = function (a, c) {
  m.asserts.assertString(m.string.Const.unwrap(a), "must provide justification");
  m.asserts.assert(
    !m.string.internal.isEmptyOrWhitespace(m.string.Const.unwrap(a)),
    "must provide non-empty justification",
...
m.html.uncheckedconversions.safeUrlFromStringKnownToSatisfyTypeContract = function (a, c) {
  m.asserts.assertString(m.string.Const.unwrap(a), "must provide justification");
  m.asserts.assert(
    !m.string.internal.isEmptyOrWhitespace(m.string.Const.unwrap(a)),
    "must provide non-empty justification",
...
m.html.uncheckedconversions.trustedResourceUrlFromStringKnownToSatisfyTypeContract = function (
  a,
  c,
) {
  m.asserts.assertString(m.string.Const.unwrap(a), "must provide justification");
...
m.dom.safe.isInnerHtmlCleanupRecursive_ = m.functions.cacheReturnValue(function () {
  if (m.DEBUG && typeof document === "undefined") {
    return !1;
  }
...
m.dom.safe.setFormElementAction = function (a, c) {
  c = c instanceof m.html.SafeUrl ? c : m.html.SafeUrl.sanitizeAssertUnchanged(c);
...
m.dom.safe.setInputFormAction = function (a, c) {
  c = c instanceof m.html.SafeUrl ? c : m.html.SafeUrl.sanitizeAssertUnchanged(c);
  m.dom.asserts.assertIsHTMLInputElement(a).formAction = m.html.SafeUrl.unwrap(c);
};
...
m.dom.safe.setNonceForScriptElement_ = function (a) {
  const c = m.getScriptNonce(a.ownerDocument && a.ownerDocument.defaultView);
...
m.dom.safe.openInWindow = function (a, c, d, e, f) {
  a = a instanceof m.html.SafeUrl ? a : m.html.SafeUrl.sanitizeAssertUnchanged(a);
  c = c || m.global;
...
m.dom.safe.createImageFromBlob = function (a) {
  ...
  const c = m.global.URL.createObjectURL(a);
...
m.string.caseInsensitiveStartsWith = m.string.internal.caseInsensitiveStartsWith;
...
m.string.numberAwareCompare_ = function (a, c, d) {
  ...
  for (
    ...
    if (d != l) {
      return (
        (a = Number.parseInt(d, 10)),
        !isNaN(a) && ((c = Number.parseInt(l, 10)), !isNaN(c) && a - c) ? a - c : d < l ? -1 : 1
      );
    }
  }
...
m.string.unescapeEntitiesUsingDom_ = function (a, c) {
  const d = { "&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"' };
  const e = c ? c.createElement("div") : m.global.document.createElement("div");
  ...
  return a.replace(/&([^;]+);/g, function (c, d) {
    switch (d) {
      ...
      case "quot":
        return '"';
      default:
        returnd.charAt(0) != "#" || ((d = Number("0" + d.slice(1))), isNaN(d))
          ? c
...
m.string.whitespaceEscape = function (a) {
  return m.string.newLineToBr(a.replace(/ {2}/g, " &#160;"), void 0);
};
m.string.preserveSpaces = function (a) {
  return a.replace(/(^|[\n ]) /g, "$1" + m.string.Unicode.NBSP);
};
m.string.stripQuotes = function (a, c) {
  for (let d = c.length, e = 0; e < d; e++) {
    const f = 1 == d ? c : c.charAt(e);
...
m.string.quote = function (a) {
  ...
  for (var c = ['"'], d = 0; d < a.length; d++) {
    const e = a.charAt(d),
      f = e.charCodeAt(0);
    c[d + 1] = m.string.specialEscapeChars_[e] || (f > 31 && f < 127 ? e : m.string.escapeChar(e));
  }
  c.push('"');
  return c.join("");
};
...
m.string.removeAt = function (a, c, d) {
  let e = a;
  c >= 0 && c < a.length && d > 0 && (e = a.substr(0, c) + a.substr(c + d, a.length - c - d));
  return e;
};
...
m.string.toNumber = function (a) {
  const c = Number(a);
  return c == 0 && m.string.isEmptyOrWhitespace(a) ? Number.NaN : c;
};
...
m.string.toTitleCase = function (a, c) {
  c = typeof c === "string" ? m.string.regExpEscape(c) : "\\s";
  return a.replace(
...
m.string.lastComponent = function (a, c) {
  ...
  for (var d = -1, e = 0; e < c.length; e++) {
    if (c[e] != "") {
      const f = a.lastIndexOf(c[e]);
      f > d && (d = f);
    }
  }
  return d == -1 ? a : a.slice(d + 1);
};
...
m.labs.userAgent.engine.isWebKit = function () {
  return (
    m.labs.userAgent.util.matchUserAgentIgnoreCase("WebKit") && !m.labs.userAgent.engine.isEdge()
  );
};
...
m.labs.userAgent.engine.getVersion = function () {
  let a = m.labs.userAgent.util.getUserAgent();
  if (a) {
    a = m.labs.userAgent.util.extractVersionTuples(a);
    const c = m.labs.userAgent.engine.getEngineTuple_(a);
    if (c) {
      returnc[0] == "Gecko" ? m.labs.userAgent.engine.getVersionForKey_(a) : c[1];
    }
    a = a[0];
    let d;
...
m.labs.userAgent.engine.getEngineTuple_ = function (a) {
  if (!m.labs.userAgent.engine.isEdge()) {
    return a[1];
  }
  for (let c = 0; c < a.length; c++) {
    const d = a[c];
...
m.labs.userAgent.engine.isVersionOrHigher = function (a) {
  return m.string.compareVersions(m.labs.userAgent.engine.getVersion(), a) >= 0;
};
...
m.labs.userAgent.platform.getVersion = function () {
  ...
  m.labs.userAgent.platform.isWindows()
    ? ((c = /Windows (?:NT|Phone) ([0-9.]+)/), (c = (a = c.exec(a)) ? a[1] : "0.0"))
    : m.labs.userAgent.platform.isIos()
      ...
      : m.labs.userAgent.platform.isMacintosh()
        ? ((c = /Mac OS X ([0-9_.]+)/), (c = (a = c.exec(a)) ? a[1].replace(/_/g, ".") : "10"))
        : m.labs.userAgent.platform.isKaiOS()
          ...
          : m.labs.userAgent.platform.isAndroid()
            ...
            : m.labs.userAgent.platform.isChromeOS() &&
              ((c = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/), (c = (a = c.exec(a)) && a[1]));
  return c || "";
};
m.labs.userAgent.platform.isVersionOrHigher = function (a) {
  return m.string.compareVersions(m.labs.userAgent.platform.getVersion(), a) >= 0;
};
m.reflect = {};
...
m.userAgent.MOBILE = m.userAgent.ASSUME_MOBILE_WEBKIT || m.userAgent.isMobile_();
m.userAgent.SAFARI = m.userAgent.WEBKIT;
m.userAgent.determinePlatform_ = function () {
  const a = m.userAgent.getNavigatorTyped();
  return (a && a.platform) || "";
};
...
m.userAgent.isLegacyLinux_ = function () {
  return m.labs.userAgent.platform.isLinux() || m.labs.userAgent.platform.isChromeOS();
};
...
m.userAgent.X11 = m.userAgent.PLATFORM_KNOWN_ ? m.userAgent.ASSUME_X11 : m.userAgent.isX11_();
...
m.userAgent.IOS = m.userAgent.PLATFORM_KNOWN_
  ? m.userAgent.ASSUME_IPHONE || m.userAgent.ASSUME_IPAD || m.userAgent.ASSUME_IPOD
  : m.labs.userAgent.platform.isIos();
...
m.userAgent.determineVersion_ = function () {
  ...
  return m.userAgent.IE &&
    ((c = m.userAgent.getDocumentMode_()), c != null && c > Number.parseFloat(a))
    ? String(c)
    : a;
};
m.userAgent.getVersionRegexResult_ = function () {
  const a = m.userAgent.getUserAgentString();
  if (m.userAgent.GECKO) {
    return /rv:([^);]+)(\)|;)/.exec(a);
  }
  if (m.userAgent.EDGE) {
  ...
  if (m.userAgent.WEBKIT) {
    return /WebKit\/(\S+)/.exec(a);
  }
  if (m.userAgent.OPERA) {
    return /(?:Version)[ /]?(\S+)/.exec(a);
  }
};
m.userAgent.getDocumentMode_ = function () {
  const a = m.global.document;
...
m.userAgent.isVersionOrHigher = function (a) {
  return (
    ...
    m.reflect.cache(m.userAgent.isVersionOrHigherCache_, a, function () {
      return m.string.compareVersions(m.userAgent.VERSION, a) >= 0;
    })
  );
};
...
if (m.global.document && m.userAgent.IE) {
  const Ea = m.userAgent.getDocumentMode_();
  Da = Ea ? Ea : Number.parseInt(m.userAgent.VERSION, 10) || void 0;
} else {
  Da = void 0;
}
    ...
    g = function (h, l) {
      ...
      try {
        if (void 0 === h) {
          ...
          var p = m.getUid(h);
          if (f[p]) {
            d.push("*** reference loop detected (id=" + p + ") ***");
          } else {
            f[p] = !0;
            d.push("{");
            for (var v in h) {
...
m.debug.normalizeErrorObject = function (a) {
  let c = m.getObjectByName("window.location.href");
  ...
  try {
    var f = a.fileName || a.filename || a.sourceURL || m.global.$googDebugFname || c;
  } catch {
    ((f = "Not available"), (d = !0));
  }
  ...
  if (!(!d && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
    ...
    if (d == null) {
      if (a.constructor && a.constructor instanceof Function) {
        const g = a.constructor.name ? a.constructor.name : m.debug.getFunctionName(a.constructor);
        d = 'Unknown Error of type "' + g + '"';
        if (m.debug.CHECK_FOR_THROWN_EVENT && g == "Event") {
          try {
            d = d + ' with Event.type "' + (a.type || "") + '"';
          } catch {}
        }
      } else {
        d = "Unknown Error of unknown type";
      }
...
m.debug.enhanceError = function (a, c) {
  a instanceof Error ||
    ((a = Error(a)), Error.captureStackTrace && Error.captureStackTrace(a, m.debug.enhanceError));
...
m.debug.enhanceErrorWithContext = function (a, c) {
  ...
  if (c) {
    for (let d in c) {
      m.debug.errorcontext.addErrorContext(a, d, c[d]);
    }
  }
  return a;
};
...
m.debug.getStacktrace = function (a) {
  let c;
  m.debug.FORCE_SLOPPY_STACKS || (c = m.debug.getNativeStackTrace_(a || m.debug.getStacktrace));
...
m.debug.getStacktraceHelper_ = function (a, c) {
  ...
  if (y(c, a)) {
    ...
    for (let e = a.arguments, f = 0; e && f < e.length; f++) {
      f > 0 && d.push(", ");
      let g = e[f];
      switch (typeof g) {
        case "object":
...
m.debug.entryPointRegistry.register = function (a) {
  m.debug.entryPointRegistry.refList_[m.debug.entryPointRegistry.refList_.length] = a;
  if (m.debug.entryPointRegistry.monitorsMayExist_) {
    for (let c = m.debug.entryPointRegistry.monitors_, d = 0; d < c.length; d++) {
...
m.debug.entryPointRegistry.monitorAll = function (a) {
  ...
  for (let c = m.bind(a.wrap, a), d = 0; d < m.debug.entryPointRegistry.refList_.length; d++) {
...
m.debug.entryPointRegistry.unmonitorAllIfPossible = function (a) {
  const c = m.debug.entryPointRegistry.monitors_;
  m.asserts.assert(a == c[c.length - 1], "Only the most recent monitor can be unwrapped.");
  a = m.bind(a.unwrap, a);
  for (let d = 0; d < m.debug.entryPointRegistry.refList_.length; d++) {
...
m.Disposable.getUndisposedObjects = function () {
  ...
  for (c in m.Disposable.instances_) {
    m.Disposable.instances_.hasOwnProperty(c) && a.push(m.Disposable.instances_[Number(c)]);
  }
  return a;
};
...
m.events.BrowserFeature = {
  ...
  HAS_W3C_EVENT_SUPPORT: !m.userAgent.IE || m.userAgent.isDocumentModeOrHigher(9),
  SET_KEY_CODE_TO_PREVENT_DEFAULT: m.userAgent.IE && !m.userAgent.isVersionOrHigher("9"),
  HAS_NAVIGATOR_ONLINE_PROPERTY: !m.userAgent.WEBKIT || m.userAgent.isVersionOrHigher("528"),
  ...
  TOUCH_ENABLED:
    ...
    !(
      !m.global.navigator ||
      (!m.global.navigator.maxTouchPoints && !m.global.navigator.msMaxTouchPoints)
    ),
  POINTER_EVENTS: "PointerEvent" in m.global,
  MSPOINTER_EVENTS:
    "MSPointerEvent" in m.global && !(!m.global.navigator || !m.global.navigator.msPointerEnabled),
  PASSIVE_EVENTS: (function () {
    if (!m.global.addEventListener || !Object.defineProperty) {
      return !1;
    }
    let a = !1,
  ...
  if (a) {
    ...
    e
      ...
      : (m.events.USE_LAYER_XY_AS_OFFSET_XY
          ...
          : ((this.offsetX = m.userAgent.WEBKIT || void 0 !== a.offsetX ? a.offsetX : a.layerX),
            (this.offsetY = m.userAgent.WEBKIT || void 0 !== a.offsetY ? a.offsetY : a.layerY)),
    ...
    this.state = a.state;
    this.event_ = a;
    a.defaultPrevented && m.events.BrowserEvent.superClass_.preventDefault.call(this);
  }
};
m.inherits(m.events.BrowserEvent, m.events.Event);
m.events.BrowserEvent.MouseButton = { LEFT: 0, MIDDLE: 1, RIGHT: 2 };
m.events.BrowserEvent.PointerType = { MOUSE: "mouse", PEN: "pen", TOUCH: "touch" };
...
m.events.BrowserEvent.prototype.preventDefault = function () {
  ...
  if (a.preventDefault) {
    a.preventDefault();
  } else if (((a.returnValue = !1), m.events.BrowserFeature.SET_KEY_CODE_TO_PREVENT_DEFAULT)) {
    try {
...
m.events.Listenable.IMPLEMENTED_BY_PROP = "closure_listenable_" + ((1e6 * Math.random()) | 0);
...
m.events.ListenerMap.prototype.add = function (a, c, d, e, f) {
  ...
  const h = m.events.ListenerMap.findListenerIndex_(a, c, e, f);
  h > -1
    ? ((c = a[h]), d || (c.callOnce = !1))
    : ((c = new m.events.Listener(c, this.src, g, !!e, f)), (c.callOnce = d), a.push(c));
  return c;
};
m.events.ListenerMap.prototype.remove = function (a, c, d, e) {
  ...
  const f = this.listeners[a];
  c = m.events.ListenerMap.findListenerIndex_(f, c, d, e);
  return c > -1
    ? (Ha(f[c]), A(f, c), f.length == 0 && (delete this.listeners[a], this.typeCount_--), !0)
    : !1;
};
const Ia = function (a, c) {
  var d = c.type;
  if (!(d in a.listeners)) {
    return !1;
  }
  var e = pa(a.listeners[d], c);
  e && (Ha(c), 0 == a.listeners[d].length && (delete a.listeners[d], a.typeCount_--));
  return e;
};
m.events.ListenerMap.prototype.removeAll = function (a) {
  ...
  for (d in this.listeners) {
    if (!a || d == a) {
      for (let e = this.listeners[d], f = 0; f < e.length; f++) {
        (++c, Ha(e[f]));
      }
...
m.events.ListenerMap.prototype.hasListener = function (a, c) {
  ...
  return m.object.some(this.listeners, function (g) {
    for (let h = 0; h < g.length; ++h) {
      if (!((d && g[h].type != e) || (f && g[h].capture != c))) {
        return !0;
      }
    }
    return !1;
...
m.events.listen = function (a, c, d, e, f) {
  if (e && e.once) {
    return m.events.listenOnce(a, c, d, e, f);
  }
  if (Array.isArray(c)) {
    for (let g = 0; g < c.length; g++) {
      m.events.listen(a, c[g], d, e, f);
    }
    return null;
  }
...
m.events.listen_ = function (a, c, d, e, f, g) {
  ...
  const h = m.isObject(f) ? !!f.capture : !!f;
  if (h && !m.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    if (m.events.CAPTURE_SIMULATION_MODE == m.events.CaptureSimulationMode.OFF_AND_FAIL) {
      return (m.asserts.fail("Can not register capture listener in IE8-."), null);
    }
    if (m.events.CAPTURE_SIMULATION_MODE == m.events.CaptureSimulationMode.OFF_AND_SILENT) {
      return null;
    }
  }
  let l = m.events.getListenerMap_(a);
  ...
  if (a.addEventListener) {
    ...
    a.attachEvent(m.events.getOnString_(c.toString()), e);
  } else if (a.addListener && a.removeListener) {
    (m.asserts.assert(c === "change", "MediaQueryList only has a change event"), a.addListener(e));
  } else {
...
m.events.getProxy = function () {
  const a = m.events.handleBrowserEvent_,
...
m.events.listenOnce = function (a, c, d, e, f) {
  if (Array.isArray(c)) {
    for (let g = 0; g < c.length; g++) {
      m.events.listenOnce(a, c[g], d, e, f);
    }
    return null;
  }
  d = m.events.wrapListener(d);
...
m.events.unlisten = function (a, c, d, e, f) {
  if (Array.isArray(c)) {
    for (let g = 0; g < c.length; g++) {
      m.events.unlisten(a, c[g], d, e, f);
    }
    return null;
  }
  e = m.isObject(e) ? !!e.capture : !!e;
  d = m.events.wrapListener(d);
  if (m.events.Listenable.isImplementedBy(a)) {
  ...
  if ((a = m.events.getListenerMap_(a))) {
    if ((c = a.getListener(c, d, e, f))) {
      return m.events.unlistenByKey(c);
    }
  }
  return !1;
};
m.events.unlistenByKey = function (a) {
  ...
  const c = a.src;
  if (m.events.Listenable.isImplementedBy(c)) {
  ...
  (d = m.events.getListenerMap_(c))
    ? (Ia(d, a), d.typeCount_ == 0 && ((d.src = null), (c[m.events.LISTENER_MAP_PROP_] = null)))
    : Ha(a);
  return !0;
};
...
m.events.removeAll = function (a, c) {
  ...
  let d = 0;
  c = c && c.toString();
  for (let e in a.listeners) {
    if (!c || e == c) {
      for (let f = a.listeners[e].concat(), g = 0; g < f.length; ++g) {
...
m.events.protectBrowserEventEntryPoint = function (a) {
  m.events.handleBrowserEvent_ = a.protectEntryPoint(m.events.handleBrowserEvent_);
};
m.events.handleBrowserEvent_ = function (a, c) {
  ...
  if (!m.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    let d = c || m.getObjectByName("window.event");
    ...
    if (m.events.CAPTURE_SIMULATION_MODE == m.events.CaptureSimulationMode.ON) {
      if (!m.events.isMarkedIeEvent_(d)) {
        ...
        a = a.type;
        for (f = d.length - 1; !c.propagationStopped_ && f >= 0; f--) {
          c.currentTarget = d[f];
          var g = m.events.fireListeners_(d[f], a, !0, c);
          e = e && g;
        }
        for (f = 0; !c.propagationStopped_ && f < d.length; f++) {
          ((c.currentTarget = d[f]), (g = m.events.fireListeners_(d[f], a, !1, c)), (e = e && g));
        }
      }
    } else {
      e = m.events.fireListener(a, c);
    }
    return e;
  }
...
m.events.LISTENER_WRAPPER_PROP_ = "__closure_events_fn_" + ((1e9 * Math.random()) >>> 0);
m.events.wrapListener = function (a) {
  m.asserts.assert(a, "Listener can not be null.");
  if (typeof a === "function") {
    return a;
  }
  m.asserts.assert(a.handleEvent, "An object listener must have handleEvent method.");
...
m.events.EventHandler.prototype.listen_ = function (a, c, d, e, f) {
  ...
  for (let g = 0; g < c.length; g++) {
    const h = m.events.listen(a, c[g], d || this.handleEvent, e || !1, f || this.handler_ || this);
    if (!h) {
      break;
    }
    this.keys_[h.key] = h;
...
b.dispatchEvent = function (a) {
  Ka(this);
  let c = this.getParentEventTarget();
  if (c) {
    var d = [];
    for (let e = 1; c; c = c.getParentEventTarget()) {
      (d.push(c), m.asserts.assert(++e < m.events.EventTarget.MAX_ANCESTORS_, "infinite loop"));
    }
  }
  return m.events.EventTarget.dispatchEventInternal_(this.actualEventTarget_, a, d);
};
b.disposeInternal = function () {
...
m.events.EventTarget.dispatchEventInternal_ = function (a, c, d) {
  const e = c.type || c;
  if (typeof c === "string") {
    c = new m.events.Event(c, a);
  } else if (c instanceof m.events.Event) {
    c.target = c.target || a;
  } else {
    var f = c;
  ...
  f = !0;
  if (d) {
    for (var g = d.length - 1; !c.propagationStopped_ && g >= 0; g--) {
...
m.math.sampleVariance = function (a) {
  ...
  const d = m.math.average.apply(null, arguments);
  return (
    m.math.sum.apply(
      null,
...
m.math.log10Floor = function (a) {
  if (a > 0) {
    const c = Math.round(Math.log(a) * Math.LOG10E);
    return c - (Number.parseFloat("1e" + c) > a ? 1 : 0);
  }
  return a == 0 ? -Infinity : Number.NaN;
};
m.math.safeFloor = function (a, c) {
  m.asserts.assert(void 0 === c || c > 0);
...
m.iter.StopIteration =
  "StopIteration" in m.global ? m.global.StopIteration : { message: "StopIteration", stack: "" };
...
m.iter.range = function (a, c, d) {
  let e = 0,
    f = a,
    g = d || 1;
  arguments.length > 1 && ((e = a), (f = +c));
  if (g == 0) {
    throw new Error("Range step argument must not be zero");
  }
  const h = new m.iter.Iterator();
  h.next = function () {
    if ((g > 0 && e >= f) || (g < 0 && e <= f)) {
      throw m.iter.StopIteration;
    }
...
m.iter.zipLongest = function (a, c) {
  const d = D(arguments, 1),
    e = new m.iter.Iterator();
  if (d.length > 0) {
    const f = x(d, m.iter.toIterator);
    e.next = function () {
      let g = !1,
        h = x(f, function (l) {
          try {
...
m.iter.starMap = function (a, c, d) {
  ...
  a = new m.iter.Iterator();
  a.next = function () {
    const f = m.iter.toArray(e.next());
    return c.apply(d, B(f, void 0, e));
  };
  return a;
};
m.iter.tee = function (a, c) {
  const d = m.iter.toIterator(a),
...
m.iter.limit = function (a, c) {
  m.asserts.assert(m.math.isInt(c) && c >= 0);
  const d = m.iter.toIterator(a);
  a = new m.iter.Iterator();
  let e = c;
  a.next = function () {
...
m.iter.consume = function (a, c) {
  m.asserts.assert(m.math.isInt(c) && c >= 0);
  for (a = m.iter.toIterator(a); c-- > 0; ) {
    m.iter.nextOrValue(a);
  }
  return a;
};
...
m.iter.permutations = function (a, c) {
  a = m.iter.toArray(a);
  c = m.iter.product.apply(void 0, ya(a, typeof c === "number" ? c : a.length));
...
m.iter.combinations = function (a, c) {
  ...
  const e = m.iter.toArray(a);
  a = m.iter.range(e.length);
  c = m.iter.permutations(a, c);
  const f = m.iter.filter(c, function (g) {
    return va(g);
  });
...
b.containsValue = function (a) {
  for (let c = 0; c < this.keys_.length; c++) {
    const d = this.keys_[c];
...
b.equals = function (a, c) {
  ...
  K(this);
  for (let d, e = 0; (d = this.keys_[e]); e++) {
...
const K = function (a) {
  ...
  if (a.count_ != a.keys_.length) {
    ...
    for (d = c = 0; c < a.keys_.length; ) {
      ((e = a.keys_[c]), m.structs.Map.hasKey_(f, e) || ((a.keys_[d++] = e), (f[e] = 1)), c++);
    }
    a.keys_.length = d;
  }
};
...
b.forEach = function (a, c) {
  for (let d = this.getKeys(), e = 0; e < d.length; e++) {
    const f = d[e],
      g = this.get(f);
    a.call(c, g, f, this);
  }
...
b.set = function (a, c) {
  let d = Ma(this, a);
  d ? (d.value = c) : ((d = new m.structs.LinkedMap.Node_(a, c)), this.map_.set(a, d), La(this, d));
};
b.peek = function () {
...
b.forEach = function (a, c) {
  for (let d = this.head_.next; d != this.head_; d = d.next) {
...
b.some = function (a, c) {
  for (let d = this.head_.next; d != this.head_; d = d.next) {
    if (a.call(c, d.value, d.key, this)) {
      return !0;
    }
  }
  return !1;
...
const La = function (a, c) {
    a.cache_
      ? ((c.next = a.head_.next), (c.prev = a.head_), (a.head_.next = c), (c.next.prev = c))
      : ((c.prev = a.head_.prev), (c.next = a.head_), (a.head_.prev = c), (c.prev.next = c));
...
m.structs.getCount = function (a) {
  return a.getCount && typeof a.getCount == "function"
    ? a.getCount()
    : m.isArrayLike(a) || typeof a === "string"
      ? a.length
      : m.object.getCount(a);
};
...
m.structs.getKeys = function (a) {
  ...
  if (!a.getValues || typeof a.getValues != "function") {
    if (m.isArrayLike(a) || typeof a === "string") {
      const c = [];
      a = a.length;
      for (let d = 0; d < a; d++) {
        c.push(d);
...
m.structs.forEach = function (a, c, d) {
  if (a.forEach && typeof a.forEach == "function") {
    a.forEach(c, d);
  } else if (m.isArrayLike(a) || typeof a === "string") {
    w(a, c, d);
  } else {
    for (
      let e = m.structs.getKeys(a), f = m.structs.getValues(a), g = f.length, h = 0;
      h < g;
      h++
    ) {
...
m.structs.filter = function (a, c, d) {
  ...
  const e = m.structs.getKeys(a),
    f = m.structs.getValues(a),
    g = f.length;
  if (e) {
    var h = {};
    for (var l = 0; l < g; l++) {
      c.call(d, f[l], e[l], a) && (h[e[l]] = f[l]);
    }
  } else {
    for (h = [], l = 0; l < g; l++) {
      c.call(d, f[l], void 0, a) && h.push(f[l]);
    }
  }
  return h;
};
m.structs.map = function (a, c, d) {
  ...
  if (e) {
    var h = {};
    for (var l = 0; l < g; l++) {
      h[e[l]] = c.call(d, f[l], e[l], a);
    }
  } else {
    for (h = [], l = 0; l < g; l++) {
      h[l] = c.call(d, f[l], void 0, a);
    }
  }
  return h;
};
m.structs.some = function (a, c, d) {
  ...
  for (let e = m.structs.getKeys(a), f = m.structs.getValues(a), g = f.length, h = 0; h < g; h++) {
...
m.uri.utils.split = function (a) {
  const c = a.match(m.uri.utils.splitRe_);
  m.uri.utils.urlPackageSupportLoggingHandler_ &&
    ["http", "https", "ws", "wss", "ftp"].includes(c[m.uri.utils.ComponentIndex.SCHEME]) &&
    m.uri.utils.urlPackageSupportLoggingHandler_(a);
  return c;
};
...
m.uri.utils.getUserInfoEncoded = function () {
  return m.uri.utils.getComponentByIndex_(m.uri.utils.ComponentIndex.USER_INFO, void 0);
};
...
m.uri.utils.getDomainEncoded = function () {
  return m.uri.utils.getComponentByIndex_(m.uri.utils.ComponentIndex.DOMAIN, void 0);
};
...
m.uri.utils.getPort = function () {
  return Number(m.uri.utils.getComponentByIndex_(m.uri.utils.ComponentIndex.PORT, void 0)) || null;
};
m.uri.utils.getPathEncoded = function () {
  return m.uri.utils.getComponentByIndex_(m.uri.utils.ComponentIndex.PATH, void 0);
};
...
m.uri.utils.getQueryData = function () {
  return m.uri.utils.getComponentByIndex_(m.uri.utils.ComponentIndex.QUERY_DATA, void 0);
};
...
m.uri.utils.removeFragment = function (a) {
  const c = a.indexOf("#");
  return c < 0 ? a : a.substr(0, c);
};
m.uri.utils.haveSameDomain = function (a, c) {
  a = m.uri.utils.split(a);
  c = m.uri.utils.split(c);
  return (
    a[m.uri.utils.ComponentIndex.DOMAIN] == c[m.uri.utils.ComponentIndex.DOMAIN] &&
    a[m.uri.utils.ComponentIndex.SCHEME] == c[m.uri.utils.ComponentIndex.SCHEME] &&
...
m.uri.utils.splitQueryData_ = function (a) {
  ...
  return [a.substr(0, d), e, a.slice(c)];
};
...
m.uri.utils.appendKeyValuePairs_ = function (a, c, d) {
  ...
  if (Array.isArray(c)) {
    ...
    c != null && d.push(a + (c === "" ? "" : "=" + m.string.urlEncode(c)));
  }
};
m.uri.utils.buildQueryData = function (a, c) {
  m.asserts.assert(
    Math.max(a.length - (c || 0), 0) % 2 == 0,
...
m.uri.utils.buildQueryDataFromMap = function (a) {
  let c = [],
    d;
  for (d in a) {
    m.uri.utils.appendKeyValuePairs_(d, a[d], c);
  }
  return c.join("&");
};
...
m.uri.utils.appendParam = function (a, c, d) {
  d = d != null ? "=" + m.string.urlEncode(d) : "";
  return m.uri.utils.appendQueryDataToUri_(a, c + d);
};
m.uri.utils.findParam_ = function (a, c, d, e) {
  for (const f = d.length; (c = a.indexOf(d, c)) >= 0 && c < e; ) {
    let g = a.charCodeAt(c - 1);
    if (g == m.uri.utils.CharCode_.AMPERSAND || g == m.uri.utils.CharCode_.QUESTION) {
      if (
        ((g = a.charCodeAt(c + f)),
        !g ||
...
m.uri.utils.hasParam = function (a, c) {
  return m.uri.utils.findParam_(a, 0, c, a.search(m.uri.utils.hashOrEndRe_)) >= 0;
};
m.uri.utils.getParamValue = function (a, c) {
  let d = a.search(m.uri.utils.hashOrEndRe_),
...
m.uri.utils.getParamValues = function (a, c) {
  for (
    ...
    (f = m.uri.utils.findParam_(a, e, c, d)) >= 0;
  ) {
    e = a.indexOf("&", f);
    if (e < 0 || e > d) {
      e = d;
...
m.uri.utils.setParam = function (a) {
  const c = m.uri.utils.StandardQueryParam.RANDOM,
...
m.uri.utils.setParamsFromMap = function (a, c) {
  ...
  d &&
    d.split("&").forEach(function (f) {
      const g = f.indexOf("=");
      c.hasOwnProperty(g >= 0 ? f.substr(0, g) : f) || e.push(f);
    });
  a[1] = m.uri.utils.appendQueryData_(e.join("&"), m.uri.utils.buildQueryDataFromMap(c));
  return m.uri.utils.joinQueryData_(a);
};
m.uri.utils.appendPath = function (a, c) {
  m.uri.utils.assertNoFragmentsOrQueries_(a);
  m.string.endsWith(a, "/") && (a = a.substr(0, a.length - 1));
  m.string.startsWith(c, "/") && (c = c.slice(1));
  return "" + a + "/" + c;
};
...
m.Uri = function (a, c) {
  ...
  a instanceof m.Uri
    ...
    : a && (d = m.uri.utils.split(String(a)))
      ...
      : ((this.ignoreCase_ = !!c), (this.queryData_ = new m.Uri.QueryData(null, this.ignoreCase_)));
};
m.Uri.RANDOM_PARAM = m.uri.utils.StandardQueryParam.RANDOM;
m.Uri.prototype.toString = function () {
  let a = [],
    c = this.getScheme();
  c && a.push(m.Uri.encodeSpecialChars_(c, m.Uri.reDisallowedInSchemeOrUserInfo_, !0), ":");
  let d = this.getDomain();
  if (d || c == "file") {
    (a.push("//"),
      (c = this.getUserInfo()) &&
        a.push(m.Uri.encodeSpecialChars_(c, m.Uri.reDisallowedInSchemeOrUserInfo_, !0), "@"),
...
m.Uri.prototype.resolve = function (a) {
  ...
  d ? Ra(c, a.getDomain()) : (d = a.port_ != null);
  let e = a.getPath();
  if (d) {
    Sa(c, a.getPort());
  } else if ((d = !!a.path_)) {
    if (e.charAt(0) != "/") {
      if (this.domain_ && !this.path_) {
        ...
        const f = c.getPath().lastIndexOf("/");
        f != -1 && (e = c.getPath().substr(0, f + 1) + e);
      }
    }
  ...
  if (m.string.contains(a, "./") || m.string.contains(a, "/.")) {
    ...
    for (var d = [], e = 0; e < a.length; ) {
      ...
      f == "."
        ? c && e == a.length && d.push("")
        : f == ".."
          ? ((d.length > 1 || (d.length == 1 && d[0] != "")) && d.pop(),
            c && e == a.length && d.push(""))
          : (d.push(f), (c = !0));
    }
    return d.join("/");
...
b.remove = function (a) {
  ...
  return this.keyMap_.containsKey(a)
    ? ((this.encodedQuery_ = null),
      (this.count_ = m.asserts.assertNumber(this.count_) - this.keyMap_.get(a).length),
...
b.getKeys = function () {
  ...
  for (
    ...
    for (let f = a[e], g = 0; g < f.length; g++) {
      d.push(c[e]);
    }
  }
  return d;
      ...
      lb = function (F) {
        if (F) {
          ...
          t.onreadystatechange = function () {
            4 == t.readyState &&
              (401 == t.status && F
                ? chrome.identity.removeCachedAuthToken({ token: F }, function () {
                    h
                      ? Xa(a, e, d, e, f, g, !1, l, n, p)
                      : (console.log(t), jb(t.status, t.responseText));
                  })
                : (console.log(t), jb(t.status, t.responseText)));
          };
          t.send(v);
        } else {
          g(Va.TOKEN_MISSING_ERROR);
        }
      };
...
const Ya = function (a, c, d, e, f, g, h, l) {
...
m.dom.BrowserFeature.OFFSCREEN_CANVAS_2D =
  ...
  (m.dom.BrowserFeature.ASSUME_OFFSCREEN_CANVAS || m.dom.BrowserFeature.detectOffscreenCanvas_());
...
m.dom.BrowserFeature.CAN_USE_INNER_TEXT = m.userAgent.IE && !m.userAgent.isVersionOrHigher("9");
...
m.dom.BrowserFeature.LEGACY_IE_RANGES = m.userAgent.IE && !m.userAgent.isDocumentModeOrHigher(9);
...
b.translate = function (a, c) {
  a instanceof m.math.Coordinate
    ...
    : ((this.x += Number(a)), typeof c === "number" && (this.y += c));
  return this;
};
b.scale = function (a, c) {
  this.x *= a;
  this.y *= typeof c === "number" ? c : a;
  return this;
};
...
b.scale = function (a, c) {
  this.width *= a;
  this.height *= typeof c === "number" ? c : a;
  return this;
};
m.dom.ASSUME_QUIRKS_MODE = !1;
m.dom.ASSUME_STANDARDS_MODE = !1;
m.dom.COMPAT_MODE_KNOWN_ = m.dom.ASSUME_QUIRKS_MODE || m.dom.ASSUME_STANDARDS_MODE;
m.dom.getDomHelper = function (a) {
  return a
    ? new m.dom.DomHelper(m.dom.getOwnerDocument(a))
    : m.dom.defaultDomHelper_ || (m.dom.defaultDomHelper_ = new m.dom.DomHelper());
};
...
m.dom.getElementHelper_ = function (a, c) {
  return typeof c === "string" ? a.getElementById(c) : c;
};
...
m.dom.getElementsByTagNameAndClass_ = function (a, c, d, e) {
  ...
  if (d) {
    e = {};
    for (g = f = 0; (h = a[g]); g++) {
      ((c = h.className), typeof c.split == "function" && y(c.split(/\s+/), d) && (e[f++] = h));
    }
    e.length = f;
    return e;
  }
...
m.dom.setProperties = function (a, c) {
  m.object.forEach(c, function (d, e) {
    d && typeof d == "object" && d.implementsGoogStringTypedString && (d = d.getTypedStringValue());
    e == "style"
      ? (a.style.cssText = d)
      : e == "class"
        ? (a.className = d)
...
m.dom.getPageScroll = function (a) {
  return m.dom.getDomHelper((a || m.global || window).document).getDocumentScroll();
};
m.dom.getDocumentScroll = function () {
  return m.dom.getDocumentScroll_(document);
};
m.dom.getDocumentScroll_ = function (a) {
  const c = m.dom.getDocumentScrollElement_(a);
  a = m.dom.getWindow_(a);
  return m.userAgent.IE && m.userAgent.isVersionOrHigher("10") && a.pageYOffset != c.scrollTop
    ? new m.math.Coordinate(c.scrollLeft, c.scrollTop)
    : new m.math.Coordinate(a.pageXOffset || c.scrollLeft, a.pageYOffset || c.scrollTop);
};
...
m.dom.createDom_ = function (a, c) {
  let d = String(c[0]),
    e = c[1];
  if (!m.dom.BrowserFeature.CAN_ADD_NAME_OR_TYPE_ATTRIBUTES && e && (e.name || e.type)) {
    d = ["<", d];
  ...
  c.length > 2 && m.dom.append_(a, d, c, 2);
  return d;
};
m.dom.append_ = function (a, c, d, e) {
  function f(h) {
    h && c.appendChild(typeof h === "string" ? a.createTextNode(h) : h);
  }
  for (; e < d.length; e++) {
    const g = d[e];
    m.isArrayLike(g) && !m.dom.isNodeLike(g) ? w(m.dom.isNodeList(g) ? C(g) : g, f) : f(g);
  }
};
...
m.dom.createTable_ = function (a, c, d, e) {
  for (
    ...
    for (var l = m.dom.createElement_(a, m.dom.TagName.TR), n = 0; n < d; n++) {
      const p = m.dom.createElement_(a, m.dom.TagName.TD);
...
m.dom.constHtmlToNode = function (a) {
  let c = x(arguments, m.string.Const.unwrap);
...
m.dom.safeHtmlToNode_ = function (a, c) {
  const d = m.dom.createElement_(a, m.dom.TagName.DIV);
  m.dom.BrowserFeature.INNER_HTML_NEEDS_SCOPED_ELEMENT
    ? (m.dom.safe.setInnerHtml(d, m.html.SafeHtml.concat(m.html.SafeHtml.BR, c)),
...
m.dom.isCss1CompatMode_ = function (a) {
  return m.dom.COMPAT_MODE_KNOWN_ ? m.dom.ASSUME_STANDARDS_MODE : a.compatMode == "CSS1Compat";
};
m.dom.canHaveChildren = function (a) {
  if (a.nodeType != m.dom.NodeType.ELEMENT) {
    return !1;
  }
  switch (a.tagName) {
...
m.dom.appendChild = function (a, c) {
  m.asserts.assert(a != null && c != null, "goog.dom.appendChild expects non-null arguments");
  a.appendChild(c);
};
...
m.dom.insertChildAt = function (a, c, d) {
  m.asserts.assert(a != null, "goog.dom.insertChildAt expects a non-null parent");
...
m.dom.replaceNode = function (a, c) {
  m.asserts.assert(a != null && c != null, "goog.dom.replaceNode expects non-null arguments");
  const d = c.parentNode;
  d && d.replaceChild(a, c);
};
m.dom.copyContents = function (a, c) {
  m.asserts.assert(a != null && c != null, "goog.dom.copyContents expects non-null arguments");
  c = c.cloneNode(!0).childNodes;
  for (m.dom.removeChildren(a); c.length; ) {
    a.appendChild(c[0]);
  }
};
...
m.dom.isNodeLike = function (a) {
  return m.isObject(a) && a.nodeType > 0;
};
...
m.dom.compareNodeOrder = function (a, c) {
  ...
  if (m.userAgent.IE && !m.userAgent.isDocumentModeOrHigher(9)) {
    if (a.nodeType == m.dom.NodeType.DOCUMENT) {
      return -1;
    }
    if (c.nodeType == m.dom.NodeType.DOCUMENT) {
      return 1;
    }
  }
    ...
    return f == g
      ...
      : !d && m.dom.contains(f, c)
        ...
        : !e && m.dom.contains(g, a)
          ...
          : (d ? a.sourceIndex : f.sourceIndex) - (e ? c.sourceIndex : g.sourceIndex);
  }
...
m.dom.getOwnerDocument = function (a) {
  ...
  return a.nodeType == m.dom.NodeType.DOCUMENT ? a : a.ownerDocument || a.document;
};
...
m.dom.getFrameContentWindow = function (a) {
  try {
    return a.contentWindow || (a.contentDocument ? m.dom.getWindow(a.contentDocument) : null);
  } catch {}
  return null;
};
m.dom.setTextContent = function (a, c) {
  m.asserts.assert(a != null, "goog.dom.setTextContent expects a non-null value for node");
  if ("textContent" in a) {
    a.textContent = c;
  } else if (a.nodeType == m.dom.NodeType.TEXT) {
    a.data = String(c);
    ...
    const d = m.dom.getOwnerDocument(a);
    a.appendChild(d.createTextNode(String(c)));
  }
};
m.dom.getOuterHtml = function (a) {
  m.asserts.assert(a !== null, "goog.dom.getOuterHtml expects a non-null value for element");
  if ("outerHTML" in a) {
    return a.outerHTML;
  }
  let c = m.dom.getOwnerDocument(a);
...
m.dom.findNodes_ = function (a, c, d, e) {
  if (a != null) {
    for (a = a.firstChild; a; ) {
      if ((c(a) && (d.push(a), e)) || m.dom.findNodes_(a, c, d, e)) {
        return !0;
      }
      a = a.nextSibling;
    }
...
m.dom.findElement = function (a, c) {
  for (a = m.dom.getChildrenReverse_(a); a.length > 0; ) {
    let d = a.pop();
    if (c(d)) {
      return d;
    }
...
m.dom.isFocusable = function (a) {
  ...
  return (c = m.dom.nativelySupportsFocus_(a)
    ? !a.disabled && (!m.dom.hasSpecifiedTabIndex_(a) || m.dom.isTabIndexFocusable_(a))
...
m.dom.hasNonZeroBoundingRect_ = function (a) {
  a =
    typeof a.getBoundingClientRect !== "function" || (m.userAgent.IE && a.parentElement == null)
      ? { height: a.offsetHeight, width: a.offsetWidth }
      : a.getBoundingClientRect();
  return a != null && a.height > 0 && a.width > 0;
};
m.dom.getTextContent = function (a) {
  if (m.dom.BrowserFeature.CAN_USE_INNER_TEXT && a !== null && "innerText" in a) {
    a = m.string.canonicalizeNewlines(a.textContent);
  } else {
    const c = [];
...
m.dom.getNodeTextOffset = function (a, c) {
  ...
  for (var d = []; a && a != c; ) {
    for (let e = a; (e = e.previousSibling); ) {
...
m.dom.getNodeAtOffset = function (a, c, d) {
  a = [a];
  for (var e = 0, f = null; a.length > 0 && e < c; ) {
  ...
  m.isObject(d) && ((d.remainder = f ? f.nodeValue.length + c - e - 1 : 0), (d.node = f));
  return f;
};
...
m.dom.getAncestorByTagNameAndClass = function (a, c, d, e) {
  ...
  const f = c ? String(c).toUpperCase() : null;
  return m.dom.getAncestor(
    a,
    function (g) {
      return (
        (!f || g.nodeName == f) &&
        (!d || (typeof g.className === "string" && y(g.className.split(/\s+/), d)))
      );
    },
    !0,
    e,
...
m.dom.getAncestor = function (a, c, d, e) {
  ...
  for (d = 0; a && (e == null || d <= e); ) {
    m.asserts.assert(a.name != "parentNode");
    if (c(a)) {
      return a;
    }
    a = a.parentNode;
...
T.prototype.onWindowReady = function () {
  const a = m.dom.getDocument().querySelector("webview");
  if (a) {
      ...
      function () {
        if (!c) {
          ...
          switch (d.env || "sandbox") {
            case "prod":
              var g = "https://payments.google.com/payments/v4/js/integrator.js";
              break;
            default:
          ...
          a.executeScript(
            ...
            function () {
              console.log("did exec once");
              a.executeScript({
                runAt: "document_end",
                code: "document.write(\"<script type=\\\"text/javascript\\\">var elem = document.createElement('div');elem.setAttribute('id', 'renderplace');elem.setAttribute('style', 'margin-left:35px;margin-right:35px;');document.body.appendChild(elem);console.log('finished loading, start payment: ' + Date.now());\x3c/script>\");",
              });
            },
          );
        }
    ...
    a.addEventListener("consolemessage", function (g) {
      g.message.indexOf("finished") != -1 && ((e.walletIsLoaded_ = !0), Za(e));
    });
    a.addEventListener(
      "newwindow",
      function (g) {
...
window.addEventListener(
  ...
  function (a) {
    ...
    if ("type" in a.data) {
      ...
      const c = chrome.app.window.current();
...
m.async.nextTick = function (a, c, d) {
  ...
  typeof m.global.setImmediate === "function" && (d || m.async.nextTick.useSetImmediate_())
    ? m.global.setImmediate(e)
    : (m.async.nextTick.setImmediate_ ||
        (m.async.nextTick.setImmediate_ = m.async.nextTick.getSetImmediateEmulator_()),
...
m.async.nextTick.getSetImmediateEmulator_ = function () {
  ...
  typeof a === "undefined" &&
    ...
    (a = function () {
      let f = m.dom.createElement(m.dom.TagName.IFRAME);
      ...
      f.open();
      f.close();
      const h = "callImmediate" + Math.random(),
        l = "file:" == g.location.protocol ? "*" : g.location.protocol + "//" + g.location.host;
      f = m.bind(function (n) {
        if ((l == "*" || n.origin == l) && n.data == h) {
  ...
  if (typeof a !== "undefined" && !m.labs.userAgent.browser.isIE()) {
    let c = new a(),
      d = {},
      e = d;
...
m.async.run.initializeRunner_ = function () {
  if (m.ASSUME_NATIVE_PROMISE || (m.global.Promise && m.global.Promise.resolve)) {
    const a = m.global.Promise.resolve(void 0);
...
m.async.run.processWorkQueue = function () {
  for (let a; (a = m.async.run.workQueue_.remove()); ) {
    try {
      a.fn.call(a.scope);
    } catch (c) {
      $a(c);
...
m.json.hybrid.parse_ = function (a) {
  ...
  if (m.global.JSON) {
    try {
      const d = m.global.JSON.parse(a);
      m.asserts.assert(typeof d == "object");
      return d;
    } catch {}
  }
  return c(a);
...
m.log.Level.createPredefinedLevelsCache_ = function () {
  ...
  for (let a = 0, c; (c = m.log.Level.PREDEFINED_LEVELS[a]); a++) {
...
m.log.Level.getPredefinedLevel = function (a) {
  m.log.Level.predefinedLevelsCache_ || m.log.Level.createPredefinedLevelsCache_();
...
m.log.Level.getPredefinedLevelByValue = function (a) {
  ...
  for (let c = 0; c < m.log.Level.PREDEFINED_LEVELS.length; ++c) {
    const d = m.log.Level.PREDEFINED_LEVELS[c];
    if (d.value <= a) {
      return d;
    }
  }
...
const fb = function (a) {
  ...
  gb = function (a, c, d, e) {
    if (!a.isBufferingEnabled()) {
      return new m.log.LogRecord(c, d, e);
    }
    var f = (a.curIndex_ + 1) % a.capacity_;
    a.curIndex_ = f;
    if (a.isFull_) {
      return ((a = a.buffer_[f]), a.reset(c, d, e), a);
    }
...
m.log.LogRegistry.getInstance = function () {
  m.log.LogRegistry.instance_ || (m.log.LogRegistry.instance_ = new m.log.LogRegistry());
  return m.log.LogRegistry.instance_;
};
m.log.getLogger = function () {
  return m.log.ENABLED ? V(m.log.LogRegistry.getInstance(), "goog.net.XhrIo", void 0).logger : null;
};
m.log.getRootLogger = function () {
  return m.log.ENABLED ? V(m.log.LogRegistry.getInstance(), m.log.ROOT_LOGGER_NAME).logger : null;
};
m.log.addHandler = function (a, c) {
  m.log.ENABLED && a && V(m.log.LogRegistry.getInstance(), a.getName()).handlers.push(c);
};
m.log.removeHandler = function (a, c) {
  return m.log.ENABLED &&
    a &&
    ((a = V(m.log.LogRegistry.getInstance(), a.getName())), (c = a.handlers.indexOf(c)), c !== -1)
    ? (a.handlers.splice(c, 1), !0)
    : !1;
};
m.log.setLevel = function (a, c) {
  m.log.ENABLED && a && (V(m.log.LogRegistry.getInstance(), a.getName()).level = c);
};
...
m.log.isLoggable = function (a, c) {
  return m.log.ENABLED && a && c ? c.value >= m.log.getEffectiveLevel(a).value : !1;
};
...
m.log.getLogRecord = function (a, c, d) {
  return gb(m.log.LogBuffer.getInstance(), c || m.log.Level.OFF, d, a.getName());
};
...
m.log.log = function (a, c, d) {
  if (m.log.ENABLED && a && m.log.isLoggable(a, c)) {
    c = c || m.log.Level.OFF;
    const e = V(m.log.LogRegistry.getInstance(), a.getName());
...
m.net.XmlHttp.ReadyState = { UNINITIALIZED: 0, LOADING: 1, LOADED: 2, INTERACTIVE: 3, COMPLETE: 4 };
...
m.Promise = function (a, c) {
  ...
  m.Promise.UNHANDLED_REJECTION_DELAY > 0
    ...
    : m.Promise.UNHANDLED_REJECTION_DELAY == 0 && (this.hadUnhandledRejection_ = !1);
...
m.Promise.getCallbackEntry_ = function (a, c, d) {
  const e = m.Promise.freelist_.get();
  e.onFulfilled = a;
  e.onRejected = c;
  e.context = d;
  return e;
...
m.Promise.resolve = function (a) {
  ...
  const c = new m.Promise(m.nullFunction);
...
m.Promise.allSettled = function (a) {
  return new m.Promise(function (c) {
    ...
    if (d) {
      for (
        let f = function (l, n, p) {
            d--;
            e[l] = n ? { fulfilled: !0, value: p } : { fulfilled: !1, reason: p };
            0 == d && c(e);
          },
          g = 0,
          h;
        ...
        ((h = a[g]), m.Promise.resolveThen_(h, m.partial(f, g, !0), m.partial(f, g, !1)));
      }
    } else {
      c(e);
    }
...
m.Promise.prototype.then = function (a, c, d) {
  a != null && m.asserts.assertFunction(a, "opt_onFulfilled should be a function.");
  c != null &&
  ...
  return ob(this, typeof a === "function" ? a : null, typeof c === "function" ? c : null, d);
};
m.Thenable.addImplementation(m.Promise);
const pb = function (a, c) {
...
m.Promise.prototype.cancel = function (a) {
  if (this.state_ == m.Promise.State_.PENDING) {
    const c = new m.Promise.CancellationError(a);
    m.async.run(function () {
      qb(this, c);
    }, this);
  }
};
const qb = function (a, c) {
    if (a.state_ == m.Promise.State_.PENDING) {
      if (a.parent_) {
            ...
            (d.state_ == m.Promise.State_.PENDING && 1 == e
              ...
              : (g
                  ? ((e = g),
                    ...
                    e.next == d.callbackEntriesTail_ && (d.callbackEntriesTail_ = e),
                    (e.next = e.next.next))
                  : rb(d),
        ...
        X(a, m.Promise.State_.REJECTED, c);
      }
    }
  },
  ub = function (a, c) {
    a.callbackEntries_ ||
      (a.state_ != m.Promise.State_.FULFILLED && a.state_ != m.Promise.State_.REJECTED) ||
      tb(a);
    m.asserts.assert(null != c.onFulfilled);
    a.callbackEntriesTail_ ? (a.callbackEntriesTail_.next = c) : (a.callbackEntries_ = c);
    ...
    f.child = new m.Promise(function (g, h) {
      ...
      f.onRejected = d
        ? function (l) {
            try {
              var n = d.call(e, l);
              void 0 === n && l instanceof m.Promise.CancellationError ? h(l) : g(n);
            } catch (p) {
              h(p);
            }
          }
...
const X = function (a, c, d) {
  a.state_ == m.Promise.State_.PENDING &&
    (a === d &&
      ((c = m.Promise.State_.REJECTED), (d = new TypeError("Promise cannot resolve to itself"))),
...
m.Promise.maybeThen_ = function (a, c, d, e) {
  if (a instanceof m.Promise) {
    return (
      c != null && m.asserts.assertFunction(c, "opt_onFulfilled should be a function."),
      d != null &&
        m.asserts.assertFunction(
          d,
          "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?",
  ...
  if (m.Thenable.isImplementedBy(a)) {
    return (a.then(c, d, e), !0);
  }
  if (m.isObject(a)) {
    try {
      const f = a.then;
      if (typeof f === "function") {
        return (m.Promise.tryThen_(a, f, c, d, e), !0);
      }
    } catch (g) {
      return (d.call(e, g), !0);
    }
...
const tb = function (a) {
  ...
  rb = function (a) {
    var c = null;
    a.callbackEntries_ &&
      ((c = a.callbackEntries_), (a.callbackEntries_ = c.next), (c.next = null));
...
m.Promise.prototype.executeCallbacks_ = function () {
  for (let a; (a = rb(this)); ) {
    (m.Promise.LONG_STACK_TRACES && this.currentStep_++, sb(this, a, this.state_, this.result_));
  }
  this.executing_ = !1;
};
const sb = function (a, c, d, e) {
  if (d == m.Promise.State_.REJECTED && c.onRejected && !c.always) {
    if (0 < m.Promise.UNHANDLED_REJECTION_DELAY) {
      for (; a && a.unhandledRejectionId_; a = a.parent_)
        (m.global.clearTimeout(a.unhandledRejectionId_), (a.unhandledRejectionId_ = 0));
    } else if (0 == m.Promise.UNHANDLED_REJECTION_DELAY) {
      for (; a && a.hadUnhandledRejection_; a = a.parent_) a.hadUnhandledRejection_ = !1;
    }
  }
  if (c.child) {
    ((c.child.parent_ = null), m.Promise.invokeCallback_(c, d, e));
  } else {
    try {
      c.always ? c.onFulfilled.call(c.context) : m.Promise.invokeCallback_(c, d, e);
    } catch (f) {
...
const nb = function (a, c) {
  ...
  vb = function (a, c) {
    if (m.Promise.LONG_STACK_TRACES && c && "string" === typeof c.stack && a.stack_.length) {
      for (var d = ["Promise trace:"], e = a; e; e = e.parent_) {
        for (var f = a.currentStep_; 0 <= f; f--) {
          d.push(e.stack_[f]);
        }
        d.push(
          "Value: [" +
...
m.Promise.addUnhandledRejection_ = function (a, c) {
  m.Promise.UNHANDLED_REJECTION_DELAY > 0
    ...
    : m.Promise.UNHANDLED_REJECTION_DELAY == 0 &&
      ...
      m.async.run(function () {
        a.hadUnhandledRejection_ && (vb(a, c), m.Promise.handleRejection_.call(null, c));
      }));
};
...
b.tick_ = function () {
  if (this.enabled) {
    const a = m.now() - this.last_;
    a > 0 && a < this.interval_ * m.Timer.intervalScale
...
m.net.XhrIo.FORM_CONTENT_TYPE = "application/x-www-form-urlencoded;charset=utf-8";
...
m.net.XhrIo.cleanup = function () {
  for (const a = m.net.XhrIo.sendInstances_; a.length; ) {
    a.pop().dispose();
  }
};
...
m.net.XhrIo.prototype.send = function (a, c, d, e) {
  ...
  this.active_ = !0;
  this.xhr_ = this.xmlHttpFactory_ ? this.xmlHttpFactory_.createInstance() : m.net.XmlHttp();
  ...
  this.progressEventsEnabled_ &&
    ...
    this.xhr_.upload && (this.xhr_.upload.onprogress = m.bind(this.onProgressHandler_, this)));
  try {
      ...
      this.timeoutInterval_ > 0 &&
        ...
        this.useXhr2Timeout_
          ? ((this.xhr_[m.net.XhrIo.XHR2_TIMEOUT_] = this.timeoutInterval_),
            (this.xhr_[m.net.XhrIo.XHR2_ON_TIMEOUT_] = m.bind(this.timeout_, this)))
          : (this.timeoutId_ = m.Timer.callOnce(this.timeout_, this.timeoutInterval_, this))),
...
m.net.XhrIo.shouldUseXhr2Timeout_ = function (a) {
  return (
    m.userAgent.IE &&
    m.userAgent.isVersionOrHigher(9) &&
    typeof a[m.net.XhrIo.XHR2_TIMEOUT_] === "number" &&
...
const Ab = function (a) {
  if (a.active_ && "undefined" != typeof m) {
    if (
      ...
      try {
        if (a.isSuccess()) {
          (a.dispatchEvent(m.net.EventType.COMPLETE), a.dispatchEvent(m.net.EventType.SUCCESS));
        } else {
          try {
            var c = Bb(a) > m.net.XmlHttp.ReadyState.LOADED ? a.xhr_.statusText : "";
          } catch (d) {
...
m.net.XhrIo.prototype.onProgressHandler_ = function (a, c) {
  ...
  this.dispatchEvent(m.net.XhrIo.buildProgressEvent_(a, m.net.EventType.PROGRESS));
  this.dispatchEvent(
...
m.net.XhrIo.buildProgressEvent_ = function (a, c) {
  return { type: c, lengthComputable: a.lengthComputable, loaded: a.loaded, total: a.total };
};
const zb = function (a, c) {
    if (a.xhr_) {
      xb(a);
      var d = a.xhr_,
        e = a.xhrOptions_[m.net.XmlHttp.OptionType.USE_NULL_FUNCTION] ? m.nullFunction : null;
      a.xhr_ = null;
      a.xhrOptions_ = null;
      ...
      try {
        ...
        m.log.error(a.logger_, "Problem encountered resetting onreadystatechange: " + f.message);
      }
    }
  },
  xb = function (a) {
    a.xhr_ && a.useXhr2Timeout_ && (a.xhr_[m.net.XhrIo.XHR2_ON_TIMEOUT_] = null);
...
Z.prototype.onAuthTokenReceived_ = function (a) {
  if (void 0 === a) {
    ...
    const c = m.bind(this.onUberAuthResponse_, this),
      d = "source=" + chrome.runtime.getManifest().oauth2.client_id,
      e = { Authorization: "Bearer " + a, "Content-Type": "application/x-www-form-urlencoded" },
      f = m.bind(function () {
        0 === this.uberTokenAttempts_
          ? (++this.uberTokenAttempts_,
            chrome.identity.removeCachedAuthToken({ token: a }, m.bind(this.authenticate, this)))
          : this.authFailedCallback_();
      }, this);
    m.net.XhrIo.send(
      Z.UBERAUTH_URL_,
      function () {
        if (this.isSuccess()) {
          try {
            ...
            (m.log.fine(this.logger_, "Can not get responseText: " + h.message), (g = ""));
          }
          c(g);
        } else {
          f();
...
Z.prototype.onUberAuthResponse_ = function (a) {
  const c = m.Uri.parse("https://accounts.google.com/MergeSession");
  P(c, "source", "appsv2");
  P(c, "uberauth", a);
...
Z.prototype.authenticate = function () {
  chrome.identity.getAuthToken({ interactive: !0 }, m.bind(this.onAuthTokenReceived_, this));
};
Z.UBERAUTH_URL_ = "https://www.google.com/accounts/OAuthLogin?issueuberauth=1";
m.craw.AppAuthenticator = Z;
const Eb = function (a, c) {
  this.url_ = a;
  this.useAuth_ = c;
};
...
const J = function (a) {
  ...
  this.webview_.addEventListener("contentload", m.bind(this.onContentLoad_, this), !1);
  this.webview_.addEventListener("newwindow", m.bind(this.onNewWindow_, this), !1);
...
const Fb = function (a) {
  a.hasLaunched_ = !1;
  a.config_.getUseAuth() ? a.authenticator_.authenticate() : a.navigateToUrl_(a.config_.getUrl());
};
b = J.prototype;
...
b.showOfflineWarning = function () {
  m.dom.getElement("app_unavailable").textContent = this.delegate_.getAppUnavailableMessage();
  m.dom.getElement("connect_to_network").textContent =
...
b.pollOnlineStatus_ = function () {
  if ((this.customStatus_ = this.delegate_.pollOnlineStatus())) {
    ...
    const a = m.bind(this.setOnlineStatus_, this),
