...
<div role="button" tabindex="0" onclick="..." onkeydown="handleEnterSpace">Click me</div>
```
...
<div role="checkbox" aria-checked="false" tabindex="0" onkeydown="handleSpace">
  <svg><!-- Check icon --></svg>
  Label
</div>
```
...
<div id="content-1" hidden>Additional content</div>

<!-- Expanded -->
<button aria-expanded="true" aria-controls="content-1">Show less</button>
<div id="content-1">Additional content</div>
```
...
<span id="email-error" role="alert"> Email format is incorrect </span>
```
...
```html
<div role="alert">Error: Please fix the errors above</div>
```
...
```html
<!-- Read only changes -->
<div aria-live="polite" aria-atomic="false"><span id="count">5</span> unread messages</div>
<!-- Announces: "6" when count changes -->

<!-- Read entire region -->
<div aria-live="polite" aria-atomic="true"><span id="count">5</span> unread messages</div>
...
<div class="accordion">
  ...
  <div id="panel-1" role="region" aria-labelledby="accordion-1" hidden>Content for section 1</div>
</div>
```
...
<div id="tooltip" role="tooltip" hidden>Additional information about this feature</div>
```
...
<div role="button" tabindex="0" onclick="doThing()" onkeydown="handleEnterSpace(event)">Click</div>
