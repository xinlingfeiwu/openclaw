...
<fieldset>
  ...
  <input type="password" id="new-password" aria-describedby="password-reqs password-strength" />
...
<span id="email-error" role="alert"> Error: Please enter a valid email address </span>
```
...
<textarea id="bio" maxlength="500" aria-describedby="bio-counter"></textarea>
<div id="bio-counter" role="status" aria-live="polite">450 characters remaining</div>
```
...
/>
<div id="file-requirements">Accepted formats: PDF, Word Document. Maximum size: 5MB.</div>
```

### Upload Status

```html
<div role="status" aria-live="polite" aria-atomic="true">Uploading file... 45% complete</div>
```
